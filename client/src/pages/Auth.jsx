        ...
        <div className='w-full h-screen flex items-center justify-center fixed top-0 right-0 bottom-0 left-0 z-50'>
            <div className='w-1/3'>
                ...
                <div className='flex flex-col span-y-2'>
                    ...
                    <input name="tc" onChange={(e) => setTc(e.target.value)} className='border-[1px] rounded-md px-3 py-2 border-input-b mb-5' placeholder='TC kimlik numaranız' />
                ...
                <div className='flex justify-end my-4'>
                    <button onClick={(e)=>authFunc(e)} type='submit' className='bg-select-b px-6 py-3 rounded-md text-white'>Giriş Yap</button>
                </div>
            </div>
        </div>
    )
